...
if mode == "gold":
    ...
    catfile   = ""
    outpath   = "/mnt/raid-cita/mlokken/data/number_density_maps/gold/"
elif mode == "maglim":
    mask_path = "/mnt/raid-cita/mlokken/data/masks/y3_gold_2.2.1_RING_joint_redmagic_v0.5.1_wide_maglim_v2.2_mask_hpx_4096.fits"
...
zsplit = True # divide by redshift bins? if false, will divide by comoving distace bins
# Maglim zbins
if zsplit:
...
if split:
    ...
    if zsplit:
        ...
        thetaphi, dists, M = csf.radec_to_thetaphi_sliced(ra, dec, z, minz, maxz, 500, masses=mass) # constant-comoving-distance method
